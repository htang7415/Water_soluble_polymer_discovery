...
CMD=(
  python scripts/step6_2_inverse_design.py
...
echo "Step 6_2 (Euler): inverse design benchmark"
...
if [ -n "$RUNS" ]; then
  ...
  echo "  Runs:           all enabled runs from config6_2"
fi
