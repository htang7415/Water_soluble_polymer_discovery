#!/usr/bin/env python
"""Build the Step 5 novelty reference cache ahead of success-hit audits."""
...
def _build_temp_step5_config(
    *,
    ...
    payload.setdefault("step5", {})["c_target"] = str(c_target)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build Step 5 novelty cache.")
    ...
    temp_config_path = _build_temp_step5_config(config_path=args.config, c_target=args.c_target)
