"""Conditional DiT backbone for Step 5."""
...
class ConditionalDiffusionBackbone(nn.Module):
    ...
    def configure_backbone_finetune(
        ...
        """Apply Step 5 backbone freeze policy.

        Semantics:
        - ``None`` or ``"full"``: full backbone fine-tune, matching the legacy Step 5 default.
        ...
        - ``0`` means the pretrained Step 1 backbone is fully frozen and only the Step 5
        ...
        # Step 5 condition path is always trainable.
